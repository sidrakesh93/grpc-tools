...
class EarlyAdopterUserDataTransferServicer(object):
  """<fill me in later!>"""
  ...
  def RetrieveAllUsersData(self, request, context):
    raise NotImplementedError()
class EarlyAdopterUserDataTransferServer(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
  def start(self):
  ...
  def stop(self):
    raise NotImplementedError()
class EarlyAdopterUserDataTransferStub(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
...
def early_adopter_create_UserDataTransfer_server(servicer, port, private_key=None, certificate_chain=None):
  ...
  method_service_descriptions = {
    "RecordSingleClientData": utilities.unary_unary_service_description(
      ...
      user_data_pb2.SingleUserRecordRequest.FromString,
      user_data_pb2.SingleUserRecordReply.SerializeToString,
    ),
    "RetrieveAllUsersData": utilities.unary_unary_service_description(
      servicer.RetrieveAllUsersData,
      user_data_pb2.AllUsersRetrieveRequest.FromString,
      user_data_pb2.AllUsersRetrieveReply.SerializeToString,
    ),
    "RetrieveSingleUserData": utilities.unary_unary_service_description(
      servicer.RetrieveSingleUserData,
      user_data_pb2.SingleUserRetrieveRequest.FromString,
      user_data_pb2.SingleUserRetrieveReply.SerializeToString,
    ),
  }
  return implementations.server("grpc.testing.UserDataTransfer", method_service_descriptions, port, private_key=private_key, certificate_chain=certificate_chain)
def early_adopter_create_UserDataTransfer_stub(host, port, metadata_transformer=None, secure=False, root_certificates=None, private_key=None, certificate_chain=None, server_host_override=None):
  import user_data_pb2
  import user_data_pb2
  import user_data_pb2
  import user_data_pb2
  ...
  method_invocation_descriptions = {
    "RecordSingleClientData": utilities.unary_unary_invocation_description(
      user_data_pb2.SingleUserRecordRequest.SerializeToString,
      user_data_pb2.SingleUserRecordReply.FromString,
    ),
    "RetrieveAllUsersData": utilities.unary_unary_invocation_description(
      user_data_pb2.AllUsersRetrieveRequest.SerializeToString,
      user_data_pb2.AllUsersRetrieveReply.FromString,
    ),
    "RetrieveSingleUserData": utilities.unary_unary_invocation_description(
      user_data_pb2.SingleUserRetrieveRequest.SerializeToString,
      user_data_pb2.SingleUserRetrieveReply.FromString,
    ),
  }
  return implementations.stub("grpc.testing.UserDataTransfer", method_invocation_descriptions, host, port, metadata_transformer=metadata_transformer, secure=secure, root_certificates=root_certificates, private_key=private_key, certificate_chain=certificate_chain, server_host_override=server_host_override)
